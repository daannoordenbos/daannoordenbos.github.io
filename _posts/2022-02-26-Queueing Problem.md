...
\begin{split}
E\left[\left(\sum_{i=1}^NR_i\right)^2\right] & = E\left[\left(\sum_{i=1}^NR_i\right)\left(\sum_{i=1}^NR_j\right)\right] \\
 & = E\left[E\left[\left(\sum_{i=1}^NR_i\right)\left(\sum_{i=1}NR_j\right)\mid N\right]\right]
\end{split}
\end{equation}
